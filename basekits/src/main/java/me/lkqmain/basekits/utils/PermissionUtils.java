...
public final class PermissionUtils {
  ...
  public abstract static class RationaleHandler {
    ...
    @TargetApi(Build.VERSION_CODES.M) public void requestPermissionsAgain() {
   ...
   * 是否彻底拒绝了某项权限
   */
  public static boolean hasAlwaysDeniedPermission(final Context context,
   ...
   * 是否有权限需要说明提示
   */
  private static boolean shouldShowRequestPermissionRationale(final Context context,
      final String... deniedPermissions) {
